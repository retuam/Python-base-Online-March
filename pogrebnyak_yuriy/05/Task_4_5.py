...
#programm body---------------------------------------------------------
#updated with Task 5 requirements

def task_4(text):
    """
    Function, than makes all routines with text for task 4.
    :param arg1: text for analyze
    :type arg1: type - string
    :return: return all routines for Task_4 
    :rtype: return type - ?empty
    """
    ...
    task_4_result = f'''input: {text}
    output:
    - words quantity: {words_count}
    - text dictionary: {text_dictionary}
    - keywords: {text_keywords}
    - frequency: {text_word_frequency}
    '''
