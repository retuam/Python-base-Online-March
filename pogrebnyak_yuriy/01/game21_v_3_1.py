...
while game:
    ...
    level = input('Chose game level OR press ENTER to continue (default level: 1 ): ')
    ...
    while level:
        ...
        while play_game:
            ...
            while i < level:
                ...
                while sum_player < 21:
                    ...
                    if i == 1:
                        ...
                        check_addcard = input('Press 1 for get additional card OR just press ENTER for PASS: ')
                        print ('')
                        ...
                        check_rate = check_rest / 21

                        combination = check_rest
                        x = 1
                        ...
                        scoring = x / 10
                        check_rnd = randint(2, 11)
                        
                        print ('scoring=', scoring, 'rate', check_rate, 'rnd', check_rnd)

                        check_score = (check_rest - check_rnd) * scoring * check_rate * 100 / check_rest
            ...
            print ('')
            play_game = input('Press 1 for try again, Press 2 for change level OR just press ENTER for QUIT: ')
